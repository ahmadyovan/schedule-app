			...
			<div className='w-full flex flex-col gap-3 px-20'>
				<div className='flex flex-col gap-3'>
					...
					<div className='w-full bg-[#cefdc2] rounded-md '>
						<div className="w-10/12 grid grid-cols-[5rem,10rem,1fr,5rem] items-center py-2 rounded gap-3">
				...
				<div className="h-full w-full flex flex-col overflow-hidden">
					<div className="h-full max-h-[45vh] w-full overflow-y-scroll flex flex-col gap-3 scroll-snap-y scroll-snap-mandatory">
						{loading
						? Array(5)
							.fill(0)
							.map((_, index) => (
